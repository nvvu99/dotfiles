...
keys = [
    ...
    Key([alt_mod], "j", lazy.layout.down(), desc="Move focus down in stack pane"),
    Key([alt_mod], "k", lazy.layout.up(), desc="Move focus up in stack pane"),
    Key([alt_mod], "h", lazy.layout.left(), desc="Move focus left in stack pane"),
    Key([alt_mod], "l", lazy.layout.right(), desc="Move focus right in stack pane"),
    ...
    Key([mod], "F4", lazy.spawn(f"{terminal} --class vifm -e vifm"), desc="Open Vifm"),
