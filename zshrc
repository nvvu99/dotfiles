...
export FZF_DEFAULT_COMMAND='ag -g "" --hidden --ignore .git --ignore node_modules --ignore venv --ignore __pycache__ --ignore mnt'
...
MODE_CURSOR_REPLACE="$MODE_CURSOR_VIINS steady underline"
MODE_CURSOR_VICMD="$MODE_CURSOR_VIINS block"
